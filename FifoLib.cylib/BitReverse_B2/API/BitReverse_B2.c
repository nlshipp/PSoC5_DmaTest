...
/* BitReverse_B2
   ...
   which alternate using a D flip flop clocked by the by the nrq dma outputs. This solves an issue from variable B that
   used a toggle flip flop clocked by the bus clock. The NRQ signals are two clocks wide causing the flip flop to be
   toggle twice.
*/
