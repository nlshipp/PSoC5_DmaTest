/*******************************************************************************
* Description:
*  Verilog implementation autogenerated from fifo.cyudb at 07/18/2023 19:52:47.
*
* Note:
...
assign f0NotFull = (f0_bus_stat);
assign f0Empty = (f0_blk_stat);
assign f1NotFull = (f1_bus_stat);
assign f1Empty = (f1_blk_stat);
...
parameter fifo_dpconfig0 = 
{
    ...
    /* Set FIFO0/1 DYN to on, assign register pairs for 16 bit access, not UDB pairs */
    3'b000, `SC_FIFO_SYNC_NONE, 2'b000, `SC_FIFO1_DYN_ON, `SC_FIFO0_DYN_ON, `SC_FIFO_CLK1_POS, `SC_FIFO_CLK0_POS, `SC_FIFO_CLK__DP, `SC_FIFO_CAP_AX, `SC_FIFO_LEVEL, `SC_FIFO__SYNC, `SC_EXTCRC_DSBL, `SC_WRK16CAT_ENBL /* CFG17-16 */
};
cy_psoc3_dp8 #(
